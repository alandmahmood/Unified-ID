                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-12 col-md-5">
                            <div class="bg-gray-200 p-4 mx-4 my-4 rounded-md flex text-black">
                                <div class="flex-1">
                                            ...
                                            <p class="text-xl mb-2 md:text-lg" style="font-size: 1rem;">Type: <?php echo $row["li_type"]; ?></p>
                                            <p class="text-xl mb-2 md:text-lg" style="font-size: 1rem;">Phone number: <?php echo $row["phone"]; ?></p>
                                            <p class="text-xl mb-2 md:text-lg" style="font-size: 1rem;">Issue Date: <?php echo $row["driving_iss"]; ?></p>
                                            <p class="text-xl mb-2 md:text-lg" style="font-size: 1rem;">Expire Date: <?php echo $row["driving_exp"]; ?></p>
                        ...
                        <div class="col-12 col-md-3 d-flex justify-content-center align-items-center rounded-3xl" 
                            ...
                            <img src="https://api.qrserver.com/v1/create-qr-code/?data=<?php echo "http://localhost/advanced/advanced/advanced/DrivingID.php?nid=" . $row['nid'] ?>&amp;size=300x300" 
