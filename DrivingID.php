                    ...
                    <div class="container">
                        <div class="row ">
                            ...
                            <div class="col-3 cold-md-3 d-flex justify-content-center align-items-center rounded-3xl" style="background-color:#1f72a2;">
                                ...
                                <img src="https://api.qrserver.com/v1/create-qr-code/?data=<?php echo "http://u-id.online/NationalID.php?nid=" . $row['nid'] ?>&amp;size=300x300" class="qr-code img-thumbnail img-responsive" />
                            </div>
                        </div>
                    </div>
                </div>
