                    ...
                    <div class="container">
                        <div class="row ">
                            ...
                            <div class="col-7 cold-md-7">
                                <div class="bg-gray-200 p-4 mx-4 my-8 rounded-md flex text-black">
                                    <!-- Content on the left -->
                                    <div class="flex-1">
                                        ...
                                        <p class="text-xl mb-2">Issue Date: <?php echo $row["national_iss"]; ?></p>
                                        <p class="text-xl mb-2">Expire Date: <?php echo $row["national_exp"]; ?></p>
