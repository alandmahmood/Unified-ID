                    ...
                    <div class="container">
                        <div class="row ">
                            ...
                            <div class="col-7 cold-md-7">
                                <div class="bg-gray-200 p-4 mx-4 my-12 rounded-md flex">
                                    <!-- Content on the left -->
                                    <div class="flex-1">
                                        ...
                                        <p class="text-xl mb-2">Gender: <?php echo $row["gender"]; ?></p>
                                        <p class="text-xl mb-2">Blood type: <?php echo $row["blood_type"]; ?></p>
                                        <p class="text-xl mb-2">Issue Date: <?php echo $row["health_iss"]; ?></p>
                                        <p class="text-xl mb-2">Expire Date: <?php echo $row["health_exp"]; ?></p>
