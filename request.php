...
<body>
    ...
    <div class="max-w-5xl mx-auto p-4">
        <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" action="additnowplz.php" method="post" enctype="multipart/form-data">
            ...
            <input hidden name="license_type" class="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="licenseType" type="text" value="A" required>
